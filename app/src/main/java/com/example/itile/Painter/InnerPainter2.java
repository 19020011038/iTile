package com.example.itile.Painter;
...
//        mTodayCheckedBackground = ContextCompat.getDrawable(context, mAttrs.todayCheckedBackground);
        mTodayCheckedBackground = context.getResources().getDrawable(R.drawable.checked_today_bg);
        mTodayUnCheckedBackground = context.getResources().getDrawable(R.drawable.unchecked_today_bg);
...
//        mTodayCheckedPoint = ContextCompat.getDrawable(context, mAttrs.todayCheckedPoint);//要改
//        mTodayUnCheckedPoint = ContextCompat.getDrawable(context, mAttrs.todayUnCheckedPoint);//要改
        mTodayCheckedPoint = context.getResources().getDrawable(R.drawable.point_checked);
        mTodayUnCheckedPoint = context.getResources().getDrawable(R.drawable.point_unchecked);
...
//            drawSolar(canvas, rectF, localDate, mAttrs.todayUnCheckedSolarTextColor, noAlphaColor);
            ...
            drawSolar(canvas, rectF, localDate, R.color.colorAccent, noAlphaColor);
            drawLunar(canvas, rectF, localDate, R.color.colorAccent, noAlphaColor);
    ...
    public void onDrawCurrentMonthOrWeek(Canvas canvas, RectF rectF, LocalDate localDate, List<LocalDate> checkedDateList) {
        if (checkedDateList.contains(localDate)) {
            drawCheckedBackground(canvas, mTodayCheckedBackground, rectF, noAlphaColor);//改了
            drawSolar(canvas, rectF, localDate, mAttrs.todayCheckedSolarTextColor, noAlphaColor);//改了
            drawLunar(canvas, rectF, localDate, mAttrs.todayCheckedLunarTextColor, noAlphaColor);//改了
            drawPoint(canvas, rectF, localDate, mTodayCheckedPoint, noAlphaColor);//改了
