...
public class ChangeTaskInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_change_task_info);
        ...
        change_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Address="http://118.190.245.170/worktile/project/"+project_id+"/task/"+task_id+"/description";
                String getInfo = info.getText().toString();
                if (TextUtils.isEmpty(getInfo)){
                    Toast.makeText(ChangeTaskInfoActivity.this,"介绍不能为空", Toast.LENGTH_SHORT).show();
                }else {
    ...
    class RadioClickListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            AlertDialog ad =new AlertDialog.Builder(ChangeTaskInfoActivity.this).setTitle("修改状态").setSingleChoiceItems(areas,lastChoose,radioOnClick).create();
...
//            Toast.makeText(MainActivity.this, "您已经选择了： " + index + ":" + areas[index], Toast.LENGTH_LONG).show();
            ChangeProjectStateWithOkhttp("http://118.190.245.170/worktile/project/"+project_id+"/task/"+task_id+"/state", radioOnClick.getStringIndex());
            dialog.dismiss();
        }
    }
        ...
        HttpUtil.changeProjectStateWithOkhttp( url,string_state, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(ChangeTaskInfoActivity.this, "网络出现了问题...", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ChangeTaskInfoActivity.this, "无法连接到服务器", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }//标签页
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ChangeTaskInfoActivity.this, "连接服务器失败", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }//标签页
